...
<body>
    <div class="sidebar">
        ...
        <a href="view_profile.php">View/update profile</a>
        <a href="apply_leave.php">Apply for leave</a>
        <a href="attendance_history.php">View attendance</a>
        <a href="performance_reviews.php">Performance reviews</a>
        <a href="payslips.php">View payslips</a>
